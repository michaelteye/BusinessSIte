                    ...
                    <div className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            <h1 className="mb-5 md:text-5xl text-3xl font-bold text-blue-900">
                             Welcome to Ideal Seed Electrical Works and Training Center 👋
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">
                            Envisioning a future where our electrical services 
                             and training programs empower individuals, businesses
                            ,and communities to thrive in a technological advanced world.
                            </div>
